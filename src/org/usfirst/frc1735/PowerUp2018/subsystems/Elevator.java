...
public class Elevator extends Subsystem {
    ...
    public void initializeElevator() {
    	...
    	//Our sensor is an analog 10-turn pot.
    	elevatorMotor.configSelectedFeedbackSensor(FeedbackDevice.Analog, 0, 0); // extra args are:  primary closed loop, timeout in ms
    	elevatorMotor.setSensorPhase(false); //Assume no inversion
        ...
        elevatorMotor.configAllowableClosedloopError(0, kToleranceHeightUnits, 0); // index, err, timeout in ms
    }
...
//		}
    ...
    // Member Variables
    public static final int kToleranceHeightUnits = 3; // stop if we are within this many encoder units of our setpoint. 1023 units across ~84in, so if we want 0.25" accuracy that's 3 ticks.
