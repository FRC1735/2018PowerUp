...
public class AutonomousExperiment extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	addSequential(new DriveWithPID(8192));
    	addSequential(new Turn(-90, Robot.driveTrain.absolute));
    	addSequential(new DriveWithPID(8192));
    	addSequential(new Turn(-180, Robot.driveTrain.absolute));
    	addSequential(new DriveWithPID(8192));
    	addSequential(new Turn(90, Robot.driveTrain.absolute));
    	addSequential(new DriveWithPID(8192));
    	addSequential(new Turn(0, Robot.driveTrain.absolute));
    } 
}
